...
//        // AN
//        mehrspindelmaschine.setMotorstatusRevolverdrehungM(RevolverdrehungM.AN);
//        assertEquals(f.output & Q_8, Q_8);
//
//        // AUS
//        beforeEach();
//        mehrspindelmaschine.setMotorstatusRevolverdrehungM(RevolverdrehungM.AUS);
...
//        // AN
//        mehrspindelmaschine.setMotorstatusWerkzeugAntriebM(WerkzeugAntriebM.AN);
//        assertEquals(f.output & Q_9, Q_9);
//
//        // AUS
//        beforeEach();
//        mehrspindelmaschine.setMotorstatusWerkzeugAntriebM(WerkzeugAntriebM.AUS);
...
//    void setStatusBandM() {
//        // AN
//        mehrspindelmaschine.setMotorstatusBandM(BandM.AN);
//        assertEquals(f.output & Q_16, Q_16);
//
//        // AUS
//        beforeEach();
//        mehrspindelmaschine.setMotorstatusBandM(BandM.AUS);
